...
# Vamos também salvar os resultados criando a pasta resultados onde ficarão os mesmos
# vou salvar na máquina, não no hdfs
# obs: tem que ser um diretório que ainda não exista
totalPorCliente.saveAsTextFile("file:/home/hadoop/teste1")
# se eu quisesse salvar no hdfs, era só trocar file por hdfs criar um diretório lá
# totalPorCliente.saveAsTextFile("hdfs:/teste1")
